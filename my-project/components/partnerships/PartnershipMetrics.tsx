...
const METRICS = [
    { stat: "1M+", label: "Stories Shared", desc: "A global legacy of storytelling that bridges divides." },
    { stat: "4-6 WEEKS", label: "Certification", desc: "Rigorous training for facilitators to master the methods." },
    { stat: "100%", label: "Human-Centric", desc: "Every partnership is built on the power of the portrait." }
];

export function PartnershipMetrics() {
    return (
        <section className="bg-black text-white py-32 md:py-64 overflow-hidden relative border-t-2 border-white/20">
            <div className="w-full max-w-[1400px] mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-8 border-b border-white/5 pb-16">
                    <div className="max-w-xl space-y-8">
                        <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40">Global Footprint</span>
                    ...
                    {METRICS.map((metric, i) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-12">
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40">PARTNERSHIP_METRIC_0{i + 1}</span>
                            </div>
