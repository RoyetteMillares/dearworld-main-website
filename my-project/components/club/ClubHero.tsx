    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden pt-24 bg-black">
            <div className="absolute inset-0 z-0">
                ...
                {/* Cinematic Gradient for Text Protection */}
                <div className="absolute inset-0 bg-linear-to-b from-black/80 via-transparent to-black/80" />
                <div className="absolute inset-0 bg-black/20" /> {/* Subtle overall dim for text pop without washing out */}
            </div>
                ...
                >
                    <div className="inline-block py-1.5 px-6 border border-white/20 text-white rounded-full">
                        <span className="text-[10px] font-black uppercase tracking-[0.5em]">
                            Leadership. Storytelling. Purpose.
                        </span>
                    </div>
                    ...
                    <p className="mt-12 max-w-2xl mx-auto text-2xl md:text-3xl font-medium leading-[1.1] text-gray-400">
                        Dear World's most exclusive offering. This isn't just a program; it's a partnership in shaping your leaders, deepening your culture, and telling your story in a way the world will remember.
                    </p>

                    <button
                        onClick={() => document.getElementById('exclusive-partnership')?.scrollIntoView({ behavior: 'smooth' })}
                        className="mt-8 px-8 py-4 bg-white text-black font-black uppercase tracking-widest text-sm hover:bg-gray-200 transition-colors rounded-full"
                    >
